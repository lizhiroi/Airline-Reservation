                                ...
                                <div class="col-lg-12">
                                    <div class="tab-content-wrap">
                                        ...
                                        <div class="content-bottom">
                                            <a href="booking-details.php" class="promo-code">+ Add Promo code</a>
                                            <a href="booking-details.php" class="btn">Show Flights <i class="flaticon-flight-1"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="booking-list-top">
                            <div class="flight-airway">
                                <div class="flight-logo">
                                    <img src="../Release/assets/img/icon/booking_icon01.jpg" alt="">
                            ...
                            <div class="flight-price">
                                <h4 class="title">CAD$ 1,056.40</h4>
                                <a href="booking-details.php" class="btn">Select <i class="flaticon-flight-1"></i></a>
                            </div>
                        </div>
                ...
                <div class="booking-list-item">
                    <div class="booking-list-item-inner">
                        <div class="booking-list-top">
                            <div class="flight-airway">
                                <div class="flight-logo">
                                    <img src="../Release/assets/img/icon/booking_icon02.jpg" alt="">
                            ...
                            <div class="flight-price">
                                <h4 class="title">CAD$ 1,099.40</h4>
                                <a href="booking-details.php" class="btn">Select <i class="flaticon-flight-1"></i></a>
                            </div>
                        </div>
                        <div class="booking-list-bottom">
                ...
                <div class="booking-list-item">
                    <div class="booking-list-item-inner">
                        <div class="booking-list-top">
                            <div class="flight-airway">
                                <div class="flight-logo">
                                    <img src="../Release/assets/img/icon/booking_icon03.jpg" alt="">
                            ...
                            <div class="flight-price">
                                <h4 class="title">CAD$ 1,200.00</h4>
                                <a href="booking-details.php" class="btn">Select <i class="flaticon-flight-1"></i></a>
                            </div>
                        </div>
                        <div class="booking-list-bottom">
                ...
                <div class="booking-list-item">
                    <div class="booking-list-item-inner">
                        <div class="booking-list-top">
                            <div class="flight-airway">
                                <div class="flight-logo">
                                    <img src="../Release/assets/img/icon/booking_icon04.jpg" alt="">
                ...
                <div class="booking-list-item">
                    <div class="booking-list-item-inner">
                        <div class="booking-list-top">
                            <div class="flight-airway">
                                <div class="flight-logo">
                                    <img src="../Release/assets/img/icon/booking_icon05.jpg" alt="">
